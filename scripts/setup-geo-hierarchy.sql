-- Thailand Geographic Hierarchy Migration Script
...
BEGIN
    ...
    RAISE NOTICE '1. Update existing business records to use the new geographic hierarchy';
    RAISE NOTICE '2. Import complete Thailand administrative data if needed';
