...
export var AnalyticsCharts = function (_a) {
    var _b;
    var data = _a.data, _c = _a.loading, loading = _c === void 0 ? false : _c;
    // Business Discovery Trends (Line Chart)
    var discoveryTrendsData = {
        ...
        datasets: [
            {
                ...
                borderColor: data.categoryBreakdown.colors.map(function (color) { return color.replace('0.8', '1'); }),
                borderWidth: 2,
            },
        ],
    };
    ...
    if (loading) {
        ...
        {[1, 2, 3, 4].map(function (i) { return (<div key={i} className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
    ...
    return (<div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">
                {data.discoveryStats.approved.reduce(function (a, b) { return a + b; }, 0)}
              </p>
            </div>
        ...
        <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 p-4 rounded-xl text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">
                {data.discoveryStats.pending.reduce(function (a, b) { return a + b; }, 0)}
              </p>
            </div>
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-4 rounded-xl text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold">
                ${((_b = data.monthlyTrends.costs[data.monthlyTrends.costs.length - 1]) === null || _b === void 0 ? void 0 : _b.toFixed(2)) || '0.00'}
              </p>
            </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
        ...
        <div className="space-y-3">
          {data.geographicData.regions.map(function (region, index) {
            var count = data.geographicData.counts[index];
            var total = data.geographicData.counts.reduce(function (a, b) { return a + b; }, 0);
            var percentage = ((count / total) * 100).toFixed(1);
            return (<div key={region} className="flex items-center space-x-4">
                <div className="w-24 text-sm font-medium">{region}</div>
                <div className="flex-1">
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-gradient-to-r from-blue-500 to-purple-500 h-2 rounded-full transition-all duration-500" style={{ width: "".concat(percentage, "%") }}/>
                  </div>
                </div>
...
export var generateSampleAnalyticsData = function () {
