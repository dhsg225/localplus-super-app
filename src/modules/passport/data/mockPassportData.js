...
mockPassportUser.badges = mockPassportBadges.filter(function (badge) { return badge.unlockedAt <= new Date(); });
// District Challenges
export var mockDistrictChallenges = [
    {
        id: 'challenge-silom',
...
// Cuisine Challenges
export var mockCuisineCallenges = [
    {
...
// Recent Activities
export var mockPassportActivities = [
    {
        id: 'activity-1',
        type: 'badge_earned',
        ...
        stampsEarned: 5,
        pointsEarned: 50,
        badgeEarned: mockPassportBadges.find(function (b) { return b.id === 'badge-weekend-warrior'; }),
    ...
    },
    {
        ...
        stampsEarned: 10,
        pointsEarned: 100,
        badgeEarned: mockPassportBadges.find(function (b) { return b.id === 'badge-thonglor-trendsetter'; }),
        createdAt: new Date('2024-12-01T14:20:00')
    }
];
// Saved Deals
export var mockSavedDeals = [
    {
        id: 'saved-1',
        dealId: 'deal-123',
        restaurantName: 'The Spice Merchant',
...
// Subscription Tiers
export var mockSubscriptionTiers = [
    {
        id: 'free',
        name: 'Free Passport',
        price: 0,
