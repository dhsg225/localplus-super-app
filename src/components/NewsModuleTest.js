        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    setError(null);
                    url = "/api/news/".concat(selectedCity, "?per_page=10");
    ...
    var fetchCategories = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    popularCategories = data.filter(function (cat) { return cat.count > 0; }).slice(0, 8);
    ...
    return (<div className="bg-white rounded-lg shadow-lg">
      ...
      <div className="p-6">
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          Showing {posts.length} articles from {availableCities[selectedCity]} • Powered by WordPress API
        </div>
      </div>
    </div>);
};
